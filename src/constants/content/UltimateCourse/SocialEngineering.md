...
#### CyberQuest's Winfred Lin engaging in anti-phishing activities:
![image](/src/assets/cyberquest_1.png)
CyberQuest offers users a transformative experience to enhance their skills in avoiding scams and phishing emails looking for confidential (and valuable data). In this specific example, which you can try **[here](https://website-name.com)**, a user is learning strategies to evade and also check the legitimacy of emails in order to evaluate whether it is a scam or not.
